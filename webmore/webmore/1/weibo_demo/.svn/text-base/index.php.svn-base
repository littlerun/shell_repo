...
$o = new SaeTOAuthV2( SinaAPPConfig::APP_KEY , SinaAPPConfig::SECRET_KEY );

//$code_url = $o->getAuthorizeURL( SinaAPPConfig::WB_CALLBACK_URL );
echo "http://api.t.sina.com.cn/statuses/public_timeline.xml?source=".SinaAPPConfig::APP_KEY;
$arr = $o->get("http://api.t.sina.com.cn/statuses/public_timeline.json",array("source"=>SinaAPPConfig::APP_KEY));
