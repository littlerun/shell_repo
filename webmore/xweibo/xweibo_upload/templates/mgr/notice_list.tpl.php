...
<div class="main-cont">
    ...
    ?>
                <tr>
                    ...
                    <td><a href="javascript:void(0);" onclick="javascript:show_detail('<?php echo $notice['notice_id']; ?>');"><?php echo F('escape', $notice['title']);?></a><div id="detail_<?php echo $notice['notice_id']; ?>" class="hidden"><div><?php echo F('escape',$notice['content']); ?></div><div>接收人：<span id="recipient_list_<?php echo $notice['notice_id']; ?>"></span></div></div></td>
