...
CREATE TABLE `xwb_page_manager` (
  ...
  `param` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=367 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='頁面設定';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `xwb_users` (
  ...
  `domain_name` varchar(45) DEFAULT NULL COMMENT '用戶設定的個性化功能變數名稱',
