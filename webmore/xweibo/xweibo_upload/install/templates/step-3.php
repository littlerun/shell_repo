...
<title><?php echo $_LANG['step2_title'];?></title>
	...
	<div id="wrap">
		...
		<div id="main">
			<div class="content-box">
				...
				<form name="theForm" method="post" action="index.php?step=3&method=check_app" class="step">
				<div class="ct-mid">
					<div class="title-info">
						<h3><?php echo $_LANG['site_name'];?></h3>
					</div>
					<div class="form-row">
						<label for=""><span>*</span><?php echo $_LANG['site_name'];?>：</label><input name="site_name" id="site_name" value="<?php echo WB_USER_SITENAME ? htmlspecialchars(WB_USER_SITENAME) : '';?>" type="text" />
					...
					<div class="form-row">
						<label for=""><span>*</span><?php echo $_LANG['site_info'];?>：</label><textarea name="site_info" id="site_info"><?php echo WB_USER_SITEINFO ? htmlspecialchars(WB_USER_SITEINFO) : '';?></textarea>
					...
					<div class="form-row">
						<label for=""><span>*</span>APP KEY：</label><input name="app_key" id="app_key" value="<?php echo WB_AKEY ? htmlspecialchars(WB_AKEY) : '';?>" type="text" />
						...
						<p><?php echo $_LANG['web_login'];?><a href="http://open.weibo.com/loginnew.php?source=xweibo" target="_blank"><?php echo $_LANG['open_site_name'];?></a><?php echo $_LANG['you_app_key'];?></p>
					</div>
					<div class="form-row">
						<label for=""><span>*</span>APP Secret：</label><input name="app_secret" id="app_secret" value="<?php echo WB_SKEY ? htmlspecialchars(WB_SKEY) : '';?>" type="text" />
					...
					<div class="btn-area">
						<a href="index.php?step=2" class="btn-common all-bg mr50"><span><?php echo $_LANG['pre_button'];?></span></a>
